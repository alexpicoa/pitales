$(function() {
    ...
    $(window).on('scroll', function (event) {
        var scroll = $(window).scrollTop();
        if (scroll < 20) {
            $(".navbar-area2").removeClass("sticky");
            $(".navbar-area2 img").attr("src", "../../assets/images/logo.svg");
        } else {
            $(".navbar-area2").addClass("sticky");
            $(".navbar-area2 img").attr("src", "../../assets/images/logo-2.svg");
        }
    });
